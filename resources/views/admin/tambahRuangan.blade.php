...
@section('container')
    <div class="container d-flex align-items-center justify-content-center">
        <div class="col-md-7">
            ...
            @endif
            <form method="POST" action="/admin/dashboard/" enctype="multipart/form-data" class="shadow border p-5">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control shadow @error('name') is-invalid @enderror"
                        value="{{ old('name') }}" name="name" id="name" placeholder="A.2.1" autocomplete="off">
                    @error('name')
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control shadow @error('room_type') is-invalid @enderror"
                        value="{{ old('room_type') }}" placeholder="Ruangan Belajar / Ruangan Komputer" name="room_type"
                ...
                <div class="mb-3">
                    ...
                    <input type="number" class="form-control shadow @error('capacity') is-invalid @enderror"
                        value="{{ old('capacity') }}" name="capacity" id="capacity" autocomplete="off">
                    @error('capacity')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control shadow @error('location') is-invalid @enderror"
                        value="{{ old('location') }}" name="location" id="location" placeholder="Gedung A Lantai 2"
                        autocomplete="off">
                    @error('location')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
